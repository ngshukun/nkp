...
# Nutanix Prism Central
export CLUSTER_NAME='sk-test' # <-- the name you create on the VM
export CONTROL_PLANE_IP=172.16.108.110 # <-- ivan provide 10 kubevip
export LB_IP_RANGE=172.16.108.11-172.16.108.11 # <-- ivan provide 10 metallb
